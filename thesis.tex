...
%
%Ringrazio i vecchi amici, che sono sempre lì: Edoardo, Matteo, Nicolò, Laura, Lucia, Leonardo, Michele e Stefania.\\
%
%Ringrazio Simone, Giulia, Marcella e Mattia. La mia personalità ora riflette anche la loro.
%
%Ringrazio Simona e Annamaria: adesso so cosa significa sentirsi a casa.
...
\begin{center}
If $T|\alpha \in M_\alpha$ and $x$ belongs to the $\alpha$th level of $T$, then $\downarrow x$ is $M_\alpha$-generic\footnotemark\ for $T|\alpha$.
\end{center}
